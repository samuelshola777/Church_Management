 ...
 private ChangeChurchAddressRequest changeChurchAddress1;
  ...
  churchService.registerANewChurchBranch(churchRequest3);
    ...
    String token = churchService.tokenGenerator("orework22@gmail.com").getToken();
        assertEquals(ValidationState.VALIDATED, churchService.verifyChurchAccount("orework22@gmail.com","goatojjbujbu123",token).getValidationState());
    }
    @Disabled
    @Test
    ...
    assertEquals(24, churchService.findChurchBranchByEmailAddress("samuelshola14@gmail.com").getId());

    }
    @Test
    void testByEmailThatReturnResponse(){
        assertEquals("samuelshola14@gmail.com", churchService.findByEmailResponse("samuelshola14@gmail.com").getEmailAddress());
    }
    @Test
